...
:hide-uri-scheme:
// Project URLs:
:url-project: https://github.com/featurehub-io/docs-ui.git
:url-preview: https://docs.featurehub.io
...
This project is forked from the {url-antora}[Antora] project and is intended to be our documentation based UI. FeatureHub
uses Antora to provide structured AsciiDoc based documentation that supports release versioning and Github pages.
